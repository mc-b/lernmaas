...
###
# containers Tools Installieren
source /etc/os-release
# Ubuntu 20
if [ "${VERSION_CODENAME}" == "focal" ]
then
    sh -c "echo 'deb http://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable/xUbuntu_20.04/ /' | sudo tee /etc/apt/sources.list.d/devel:kubic:libcontainers:stable.list"
